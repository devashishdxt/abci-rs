...
impl ResponseQuery {
    ...
    pub fn get_proof(&self) -> &super::merkle::Proof {
        self.proof.as_ref().unwrap_or_else(|| <super::merkle::Proof as ::protobuf::Message>::default_instance())
    }
...
impl BlockID {
    ...
    pub fn get_parts_header(&self) -> &PartSetHeader {
        self.parts_header.as_ref().unwrap_or_else(|| <PartSetHeader as ::protobuf::Message>::default_instance())
    }
...
impl ValidatorUpdate {
    ...
    pub fn get_pub_key(&self) -> &PubKey {
        self.pub_key.as_ref().unwrap_or_else(|| <PubKey as ::protobuf::Message>::default_instance())
    }
