...
impl RequestInitChain {
    ...
    pub fn get_time(&self) -> &::protobuf::well_known_types::Timestamp {
        self.time.as_ref().unwrap_or_else(|| {
    ...
    pub fn get_consensus_params(&self) -> &ConsensusParams {
        self.consensus_params
            .as_ref()
            .unwrap_or_else(|| <ConsensusParams as ::protobuf::Message>::default_instance())
    }
...
impl RequestBeginBlock {
    ...
    pub fn get_last_commit_info(&self) -> &LastCommitInfo {
        self.last_commit_info
            .as_ref()
            .unwrap_or_else(|| <LastCommitInfo as ::protobuf::Message>::default_instance())
    }
...
impl ResponseQuery {
    ...
    pub fn get_proof(&self) -> &super::merkle::Proof {
        self.proof
            .as_ref()
            .unwrap_or_else(|| <super::merkle::Proof as ::protobuf::Message>::default_instance())
    }
...
impl ConsensusParams {
    ...
    pub fn get_block(&self) -> &BlockParams {
        self.block
            .as_ref()
            .unwrap_or_else(|| <BlockParams as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_evidence(&self) -> &EvidenceParams {
        self.evidence
            .as_ref()
            .unwrap_or_else(|| <EvidenceParams as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_validator(&self) -> &ValidatorParams {
        self.validator
            .as_ref()
            .unwrap_or_else(|| <ValidatorParams as ::protobuf::Message>::default_instance())
    }
...
impl EvidenceParams {
    ...
    pub fn get_max_age_duration(&self) -> &::protobuf::well_known_types::Duration {
        self.max_age_duration.as_ref().unwrap_or_else(|| {
            <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance()
        })
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>,
                >(
                    "max_age_duration",
...
impl Header {
    ...
    pub fn get_version(&self) -> &Version {
        self.version
            .as_ref()
            .unwrap_or_else(|| <Version as ::protobuf::Message>::default_instance())
    }
    pub fn clear_version(&mut self) {
        self.version.clear();
    }
    ...
    pub fn get_last_block_id(&self) -> &BlockID {
        self.last_block_id
            .as_ref()
            .unwrap_or_else(|| <BlockID as ::protobuf::Message>::default_instance())
    }
...
impl BlockID {
    ...
    pub fn get_parts_header(&self) -> &PartSetHeader {
        self.parts_header
            .as_ref()
            .unwrap_or_else(|| <PartSetHeader as ::protobuf::Message>::default_instance())
    }
...
impl ValidatorUpdate {
    ...
    pub fn get_pub_key(&self) -> &PubKey {
        self.pub_key
            .as_ref()
            .unwrap_or_else(|| <PubKey as ::protobuf::Message>::default_instance())
    }
...
impl VoteInfo {
    ...
    pub fn get_validator(&self) -> &Validator {
        self.validator
            .as_ref()
            .unwrap_or_else(|| <Validator as ::protobuf::Message>::default_instance())
    }
    pub fn clear_validator(&mut self) {
        self.validator.clear();
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x12;\n\rlast_block_id\x18\x05\x20\x01(\x0b2\x1e.tendermint.abci.typ\
    es.BlockIDB\x04\xc8\xde\x1f\0\x12\x1a\n\x10last_commit_hash\x18\x06\x20\
    \x01(\x0cB\0\x12\x13\n\tdata_hash\x18\x07\x20\x01(\x0cB\0\x12\x19\n\x0fv\
    alidators_hash\x18\x08\x20\x01(\x0cB\0\x12\x1e\n\x14next_validators_hash\
    \x18\t\x20\x01(\x0cB\0\x12\x18\n\x0econsensus_hash\x18\n\x20\x01(\x0cB\0\
    \x12\x12\n\x08app_hash\x18\x0b\x20\x01(\x0cB\0\x12\x1b\n\x11last_results\
    _hash\x18\x0c\x20\x01(\x0cB\0\x12\x17\n\revidence_hash\x18\r\x20\x01(\
    ...
    \0B\x1c\xb8\xe2\x1e\x01\xa8\xe2\x1e\x01\xf8\xe1\x1e\x01\xd0\xe2\x1e\x01\
    \xc8\xe2\x1e\x01\xc0\xe3\x1e\x01\xe0\xe2\x1e\x01b\x06proto3\
";
